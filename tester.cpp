 ...
 * walk a single path through there decision tree that they
 * implement. the return value is the number of the leaf that was
 * reached by that traversal.
 *
 * the painful part of this interface is that leaf numbers should be
 * fairly dense, ideally perfectly dense with range 0 .. NUM_LEAVES-1.
